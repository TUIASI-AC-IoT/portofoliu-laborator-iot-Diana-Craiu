    ...
    while(1)
    {
        ...
        while (1) {
            ...
            // Data received
                ...
                // daca GPIO4=0 atunci se stinge LED ul
                if (strcmp(rx_buffer, "GPIO4=0") == 0) {
                    gpio_set_level(GPIO_LED, 0);  // LED stins
                }
                // daca GPIO4=1 atunci se aprinde LED ul
                else if (strcmp(rx_buffer, "GPIO4=1") == 0) {
                    gpio_set_level(GPIO_LED, 1);  // LED aprins
                }
            }
